...
class DemoData {
  ...
  static const supportTickets = <SupportTicket>[
    ...
    SupportTicket(
      id: 'TKT-1041',
      subject: "Can't log in — OTP never arrives",
      user: 'Priya Mehta',
    ...
    SupportTicket(
      id: 'TKT-1040',
      subject: 'App crashes when scanning a visitor QR',
      user: 'Imran Khan',
      property: 'Cyber Heights Corporate Park',
      category: 'Bug',
      priority: 'High',
      status: 'In Progress',
      ago: '2h ago',
    ...
    SupportTicket(
      id: 'TKT-1039',
      subject: 'Notice attachments will not open',
      user: 'Sneha Patil',
    ...
    SupportTicket(
      id: 'TKT-1038',
      subject: 'Please add UPI autopay option',
      user: 'Arjun Rao',
    ...
    SupportTicket(
      id: 'TKT-1037',
      subject: 'Wrong maintenance amount shown',
      user: 'Meera Joshi',
      property: 'Silver Oak Apartments',
      category: 'Payment',
      priority: 'Medium',
      status: 'Resolved',
      ago: '1d ago',
